...
const Home = () => {
    ...
    const bike_img_1 = "https://i.ibb.co/qjHdYKD/background-03-1920x800.jpg";
    const bike_img_2 = "https://i.ibb.co/1RChPwn/background-04-1920x800.jpg";
    const bike_img_3 = "https://i.ibb.co/hsGHzjh/background-02-1920x800.jpg";
    const btn_theme = ">>";
                    ...
                    <div className="col-12">
                        <div id="carouselExampleDark" className="carousel carousel-dark slide" data-bs-ride="carousel">
                            ...
                            <div className="carousel-inner">
                                ...
                                <div className="carousel-caption d-none d-md-block text-light">
                                    <h5>Remember, it’s more about the journey than the destination.</h5>
